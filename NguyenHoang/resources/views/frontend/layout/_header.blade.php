        ...
        <div class="col-md-6 navr">
            <ul>
                ...
                <li>
                    ...
                    @if (Auth::check())
                        <a class="btn btn-secondary dropdown-toggle active-user" href="" role="button"
                            id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-user"></i><span class="inuser">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            @if (Auth::user()->id_phanquyen == 3)
                                <a class="dropdown-item DI" href="{{ url('register-admin') }}">Thêm tài khoản
                                    admin</a>
                            @endif
                    ...
                    @else
                        <a href="{{ url('login') }}" class="btn btn-default btn-rounded my-3 user"><i
                                class="fas fa-user"></i><span class="inuser">Tài khoản</span></a>
                    @endif
